...
// include: C:\Users\wojciech\AppData\Local\Temp\tmpwnx1421y.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'SLICK_GAME.data';
      var REMOTE_PACKAGE_BASE = 'SLICK_GAME.data';
...
Module['FS_createPath']("/", "LdkLevels", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_SLICK_GAME.data');
      }
      Module['addRunDependency']('datafile_SLICK_GAME.data');
    ...
    loadPackage({"files": [{"filename": "/LdkLevels/Level_0.csv", "start": 0, "end": 2591}, {"filename": "/LdkLevels/Level_1.csv", "start": 2591, "end": 5344}, {"filename": "/LdkLevels/Level_2.csv", "start": 5344, "end": 8097}, {"filename": "/LdkLevels/Level_3.csv", "start": 8097, "end": 9266}], "remote_package_size": 9266});

  })();

// end include: C:\Users\wojciech\AppData\Local\Temp\tmpwnx1421y.js
// include: C:\Users\wojciech\AppData\Local\Temp\tmp2wuanesn.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\wojciech\AppData\Local\Temp\tmp2wuanesn.js
// include: C:\Users\wojciech\AppData\Local\Temp\tmp31cecdvl.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\wojciech\AppData\Local\Temp\tmp31cecdvl.js
...
function findWasmBinary() {
  return locateFile('SLICK_GAME.wasm');
}
...
var ASM_CONSTS = {
  119056: () => { if (document.fullscreenElement) return 1; },  
 119102: () => { return document.getElementById('canvas').width; },  
 119154: () => { return parseInt(document.getElementById('canvas').style.width); },  
 119222: () => { document.exitFullscreen(); },  
 119249: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 119322: () => { if (document.fullscreenElement) return 1; },  
 119368: () => { return document.getElementById('canvas').width; },  
 119420: () => { return screen.width; },  
 119445: () => { document.exitFullscreen(); },  
 119472: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 119605: () => { return window.innerWidth; },  
 119631: () => { return window.innerHeight; },  
 119658: () => { if (document.fullscreenElement) return 1; },  
 119704: () => { return document.getElementById('canvas').width; },  
 119756: () => { return parseInt(document.getElementById('canvas').style.width); },  
 119824: () => { if (document.fullscreenElement) return 1; },  
 119870: () => { return document.getElementById('canvas').width; },  
 119922: () => { return screen.width; },  
 119947: () => { return window.innerWidth; },  
 119973: () => { return window.innerHeight; },  
 120000: () => { if (document.fullscreenElement) return 1; },  
 120046: () => { return document.getElementById('canvas').width; },  
 120098: () => { return screen.width; },  
 120123: () => { document.exitFullscreen(); },  
 120150: () => { if (document.fullscreenElement) return 1; },  
 120196: () => { return document.getElementById('canvas').width; },  
 120248: () => { return parseInt(document.getElementById('canvas').style.width); },  
 120316: () => { document.exitFullscreen(); },  
 120343: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 120401: () => { return screen.width; },  
 120426: () => { return screen.height; },  
 120452: () => { return window.screenX; },  
 120479: () => { return window.screenY; },  
 120506: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 120559: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 120630: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 120687: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 120943: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 121014: () => { if (document.fullscreenElement) return 1; },  
 121060: () => { return window.innerWidth; },  
 121086: () => { return window.innerHeight; },  
 121113: () => { if (document.pointerLockElement) return 1; }
};
